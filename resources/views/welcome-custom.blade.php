<x-public-layout title="SaferWealth Analyst">
    <!-- Hero Section -->
    <section class="hero-gradient relative overflow-hidden min-h-[90vh] flex items-center">
        <!-- Subtle pattern overlay -->
        <div class="absolute inset-0 opacity-5 pointer-events-none">
            <div class="absolute inset-0"
                style="background-image:radial-gradient(circle at 2px 2px, hsl(175 45% 32%) 1px, transparent 0);background-size:40px 40px;">
            </div>
        </div>
        <!-- Decorative elements -->
        <div class="absolute top-20 right-10 w-72 h-72 bg-primary/10 rounded-full blur-3xl pointer-events-none"></div>
        <div class="absolute bottom-20 left-10 w-96 h-96 bg-green-400/10 rounded-full blur-3xl pointer-events-none">
        </div>
        <div class="container relative z-10 py-20 lg:py-32" style="margin: 0 auto">
            <div class="max-w-4xl mx-auto text-center">
                ...
                <h1 class="font-display text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6">
                    Find Out If Your Business <span class="text-gradient">Qualifies for Funding</span> in Days — Not
                    Weeks
                </h1>
                <!-- Subheading -->
                <p class="text-lg md:text-xl  text-foreground/80 max-w-2xl mx-auto mb-10">
                    Our secure platform analyzes your financial documents and gives you a clear answer on loan
                    eligibility — so you can stop guessing and start planning.
                </p>
                <!-- CTA Buttons -->
                <div class="flex flex-col sm:flex-row gap-4 justify-center mb-12">
                    @auth
                        <a href="{{ route('dashboard') }}"
                            class="group bg-primary px-8 py-4 text-white rounded-lg font-semibold text-lg flex items-center justify-center gap-2 hover:opacity-90 transition-all duration-200 transform hover:-translate-y-1">
                    ...
                    @endauth
                    <a href="#how-it-works"
                        class="px-8 py-4 bg-white/90 border border-border text-foreground rounded-lg font-semibold text-lg flex items-center justify-center gap-2 hover:bg-white transition">See
                        How It Works</a>
                </div>
                <!-- Features List -->
                <div class="flex flex-wrap justify-center gap-6 text-gray-700/70 text-sm">
                    <div class="flex items-center gap-2">
                        <svg class="w-4 h-4 text-[#2d7670]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <!-- Pain Points Section -->
    <section id="about" class="py-20 lg:py-28 bg-gray-100 scroll-mt-24">
        <div class="container mx-auto">
            <div class="text-center max-w-3xl mx-auto mb-16">
                ...
                <p class="text-lg text-[#2d7670]">
                    Getting business funding shouldn't feel like a battle. But for too many Canadian entrepreneurs,
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white rounded-xl p-6 shadow border border-gray-200">
                    ...
                    <p class="text-muted-foreground">Banks take forever to respond. You're left in limbo while your
                        business needs capital now.</p>
                </div>
                <!-- Pain Point 2 -->
                <div class="bg-white rounded-xl p-6 shadow border border-gray-200">
                    <div class="w-12 h-12 rounded-lg bg-red-100 flex items-center justify-center mb-4">
                        ...
                        <svg class="w-6 h-6 text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v.01" />
                        </svg>
                    </div>
                    <h3 class="font-display text-xl font-semibold text-foreground mb-2">Endless Paperwork</h3>
                    <p class="text-muted-foreground">The same documents requested over and over. Tax returns, bank
                        statements, projections — again and again.</p>
                </div>
                <!-- Pain Point 3 -->
                <div class="bg-white rounded-xl p-6 shadow border border-gray-200">
                    <div class="w-12 h-12 rounded-lg bg-red-100 flex items-center justify-center mb-4">
                    ...
                    <p class="text-muted-foreground">You don't know if you qualify until you've already invested weeks
                        of effort.</p>
                </div>
                <!-- Pain Point 4 -->
                <div class="bg-white rounded-xl p-6 shadow border border-gray-200">
                    ...
                    <p class="text-muted-foreground">The anxiety of not knowing eats away at you. What if all this work
                        is for nothing?</p>
                </div>
                <!-- Pain Point 5 -->
                <div class="bg-white rounded-xl p-6 shadow border border-gray-200">
                    <div class="w-12 h-12 rounded-lg bg-red-100 flex items-center justify-center mb-4">
                        ...
                        <svg class="w-6 h-6 text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M21 7v6a2 2 0 01-2 2H7l-4 4" />
                        </svg>
                    </div>
                    <h3 class="font-display text-xl font-semibold text-foreground mb-2">Missed Opportunities</h3>
                    <p class="text-muted-foreground">While you wait, that perfect location, equipment, or expansion
                ...
                <div class="bg-white rounded-xl p-6 shadow border border-gray-200">
                    ...
                    <p class="text-muted-foreground">Cash flow pressure builds. Every day without an answer feels like a
                        step backward.</p>
                </div>
            </div>
            ...
            <div class="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                <div>
                    ...
                    <p class="text-lg text-muted-foreground mb-8">
                        The traditional lending process was built decades ago. It wasn't designed for today's
                        fast-moving business world — or for entrepreneurs who need answers now.
                    </p>
                    <div class="space-y-4">
                ...
                <div class="relative">
                    <div
                        class="bg-gradient-to-br from-primary/10 to-white rounded-2xl p-8 lg:p-12 border border-primary/20">
                        <div class="space-y-6">
                            <div class="flex items-center gap-4">
                                <div class="w-16 h-16 rounded-full bg-primary/20 flex items-center justify-center">
                                    <svg class="w-8 h-8 text-[#2d7670]" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M9.75 3v2.25M14.25 3v2.25M4.5 8.25h15M6.75 6h10.5A2.25 2.25 0 0119.5 8.25v9A2.25 2.25 0 0117.25 19.5H6.75A2.25 2.25 0 014.5 17.25v-9A2.25 2.25 0 016.75 6zM9 12.75l1.5 1.5 3.75-3.75" />
                                    </svg>
                                </div>
                                <div class="space-y-2 flex-1">
                                    <p class="text-sm font-semibold text-foreground">AI Document Review</p>
                                    <p class="text-xs text-muted-foreground">Secure automated analysis + eligibility
                                        checks</p>
                                </div>
                            </div>
                            <div class="grid grid-cols-3 gap-2 text-center text-xs">
                                <div class="bg-white/80 border border-border rounded-md py-2 text-foreground">Upload
                                </div>
                                <div
                                    class="bg-primary/15 border border-primary/30 rounded-md py-2 text-[#2d7670] font-medium">
                                    AI Analysis</div>
                                <div class="bg-white/80 border border-border rounded-md py-2 text-foreground">Result
                                </div>
                            </div>
                    ...
                    <!-- Decorative label -->
                    <div
                        class="absolute -top-3 -right-3 bg-primary text-white text-xs font-semibold px-3 py-1.5 rounded-full shadow">
                        AI Process
                    </div>
                </div>
            </div>
        ...
        <div class="container bg-primary relative z-10" style="margin: 0 auto">
            <div class="text-center max-w-3xl mx-auto mb-16">
                <div class="inline-flex items-center gap-2 bg-white/10 rounded-full px-4 py-2 mb-6">
                    <!-- Zap icon -->
                    <svg class="w-4 h-4 bg-secondary/20" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <p class="text-lg text-white/80">
                    Our platform combines secure technology with intelligent analysis to give you clarity on your loan
                    eligibility — quickly, privately, and accurately.
                </p>
            </div>
            <div class="grid md:grid-cols-2 gap-6 lg:gap-8 mb-12">
                ...
                <div class="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6 lg:p-8">
                    <div class="w-12 h-12 rounded-lg flex items-center justify-center mb-4">
                        <!-- Lock icon -->
                        <svg class="w-6 h-6 bg-secondary/20" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <section id="benefits" class="py-20 lg:py-28 bg-white scroll-mt-24">
        <div class="container mx-auto">
            <div class="text-center max-w-3xl mx-auto mb-16">
                <h2 class="font-display text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-6">What You'll
                    Gain</h2>
                <p class="text-lg text-muted-foreground">This isn't just about checking eligibility — it's about getting
                    your time and confidence back.</p>
            </div>
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                <!-- Benefit 1 -->
                <div class="text-center">
                    <div
                        class="w-16 h-16 rounded-2xl bg-gradient-to-br from-primary/20 to-primary/5 flex items-center justify-center mx-auto mb-4">
                        <!-- Clock icon -->
                ...
                <div class="text-center">
                    ...
                    <h3 class="font-display text-xl font-semibold text-gray-900 mb-2">Avoid Unnecessary Applications
                    </h3>
                ...
                <div class="text-center">
                    <div
                        ...
                        <svg class="w-7 h-7 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M17 7a5 5 0 00-10 0v10a5 5 0 0010 0V7z" />
                        </svg>
                    </div>
            ...
            <div class="mt-16 text-center">
                <div class="inline-flex items-center gap-3 bg-green-100 text-green-700 px-6 py-3 rounded-full">
                    ...
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M14 9V5a3 3 0 00-6 0v4m0 0H5a2 2 0 00-2 2v7a2 2 0 002 2h14a2 2 0 002-2v-7a2 2 0 00-2-2h-3z" />
                    </svg>
    ...
    <section class="py-20 lg:py-28 bg-gray-100">
        <div class="container mx-auto">
            <div class="text-center max-w-3xl mx-auto mb-16">
                <h2 class="font-display text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-6">Is This Right
                    For You?</h2>
                <p class="text-lg text-muted-foreground">Our eligibility assessment is designed for Canadian business
                    owners and entrepreneurs at every stage.</p>
            </div>
            <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white rounded-xl p-6 shadow border border-gray-200 flex items-start gap-4">
                    ...
                    <div>
                        <h3 class="font-display text-lg font-semibold text-foreground mb-1">Existing Business Owners
                        </h3>
                ...
                <div class="bg-white rounded-xl p-6 shadow border border-gray-200 flex items-start gap-4">
                    <div class="w-12 h-12 rounded-lg bg-primary/10 flex items-center justify-center flex-shrink-0">
                        <!-- Rocket icon -->
                        <svg class="w-6 h-6 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path d="M4 20l1.5-1.5M19.5 4.5L20 4m-7.5 7.5l7.5-7.5M4 20l7.5-7.5" />
                            <circle cx="12" cy="12" r="2" />
                        </svg>
                    </div>
                    <div>
                ...
                <div class="bg-white rounded-xl p-6 shadow border border-gray-200 flex items-start gap-4">
                    ...
                    <div>
                        <h3 class="font-display text-lg font-semibold text-foreground mb-1">Bank-Declined Applicants
                        </h3>
    ...
    <section id="how-it-works" class="py-20 lg:py-28 bg-white scroll-mt-24">
        <div class="container mx-auto">
            <div class="text-center max-w-3xl mx-auto mb-16">
                <h2 class="font-display text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-6">How It Works
                </h2>
                ...
                <div class="relative">
                    <div class="flex gap-6 mb-8">
                        <div class="flex-shrink-0">
                            <div
                                class="w-12 h-12 rounded-xl bg-gradient-to-br from-primary to-primary/70 flex items-center justify-center shadow-lg">
                                <!-- Upload icon -->
                        ...
                        <div class="flex-1 pb-8 border-b border-gray-200">
                            ...
                            <h3 class="font-display text-xl font-semibold text-foreground mb-2">Upload Your Documents
                            </h3>
                            <p class="text-gray-600">Securely submit your financial documents through our encrypted
                                platform. Bank statements, tax returns, and business financials.</p>
                        </div>
                    </div>
                    <!-- Connector line -->
                    <div
                        class="absolute left-6 top-20 w-0.5 h-16 bg-gradient-to-b from-primary to-primary/70 hidden md:block">
                    </div>
                </div>
                <!-- Step 2 -->
                <div class="relative">
                    <div class="flex gap-6 mb-8">
                        ...
                        <div class="flex-1 pb-8 border-b border-gray-200">
                            ...
                            <h3 class="font-display text-xl font-semibold text-foreground mb-2">We Analyze Your
                                Financials</h3>
                            <p class="text-gray-600">Our AI-assisted system reviews your documents for loan eligibility
                                indicators and identifies any missing information.</p>
                        </div>
                    </div>
                    <div
                        class="absolute left-6 top-20 w-0.5 h-16 bg-gradient-to-b from-primary to-primary/70 hidden md:block">
                ...
                <div class="relative">
                    <div class="flex gap-6 mb-8">
                        ...
                        <div class="flex-1 pb-8 border-b border-gray-200">
                            ...
                            <h3 class="font-display text-xl font-semibold text-foreground mb-2">Receive Clear Feedback
                            </h3>
                            <p class="text-gray-600">Get a straightforward assessment of your eligibility status along
                                with specific recommendations.</p>
                        </div>
                    </div>
                    <div
                        class="absolute left-6 top-20 w-0.5 h-16 bg-gradient-to-b from-blue-600 to-gray-200 hidden md:block">
                    </div>
                </div>
                <!-- Step 4 -->
                <div class="relative">
                    <div class="flex gap-6 mb-8">
                        ...
                        <div class="flex-1 pb-8 border-b border-gray-200 last:border-b-0">
                            ...
                            <h3 class="font-display text-xl font-semibold text-foreground mb-2">Book Your Consultation
                            </h3>
                            <p class="text-gray-600">If you qualify, schedule a call with our team to discuss your
                                funding options and next steps.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="py-20 lg:py-28 bg-primary text-white relative overflow-hidden">
        ...
        <div class="container relative z-10" style="margin: 0 auto">
            <div class="text-center max-w-3xl mx-auto mb-16">
                ...
                <p class="text-lg text-white/80">We understand you're sharing sensitive financial information. That's
                    why we've built our platform with security as the foundation.</p>
            </div>
            <div class="grid md:grid-cols-2 gap-6 lg:gap-8 max-w-4xl mx-auto">
                ...
                <div class="flex items-start gap-4 bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10">
                    <div class="w-10 h-10 rounded-lg flex items-center justify-center flex-shrink-0">
                        <!-- Lock icon -->
                        <svg class="w-5 h-5 bg-secondary/20" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <rect x="3" y="11" width="18" height="11" rx="2" />
                            <path d="M7 11V7a5 5 0 0110 0v4" />
                        </svg>
                    </div>
                    <div>
                        ...
                        <p class="text-sm text-white/70">256-bit SSL encryption protects all your data in transit and at
                            rest.</p>
                    </div>
                </div>
                <!-- Trust Point 2 -->
                ...
                <div class="flex items-start gap-4 bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-white/70">Your information is used only for eligibility assessment.
                            Period.</p>
                    </div>
                </div>
                <!-- Trust Point 4 -->
    ...
    <section id="faq" class="py-20 lg:py-28 bg-gray-100 scroll-mt-24">
        <div class="container mx-auto">
            <div class="text-center max-w-3xl mx-auto mb-16">
                <h2 class="font-display text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-6">Common
                    Questions</h2>
            ...
            <div class="max-w-3xl mx-auto">
                <div class="space-y-4">
                    ...
                    <details class="bg-white rounded-xl border border-gray-200 px-6 overflow-hidden shadow">
                        <summary class="text-left font-display font-semibold text-muted-foreground py-5 cursor-pointer">
                            Is this a loan application?</summary>
                        <div class="text-gray-600 pb-5">No. This is an eligibility assessment only. We analyze your
                            documents to determine if you're likely to qualify for business financing. If you are, we'll
                            guide you to the next steps. There's no commitment to proceed.</div>
                    </details>
                    <!-- FAQ 2 -->
                    <details class="bg-white rounded-xl border border-gray-200 px-6 overflow-hidden shadow">
                        <summary class="text-left font-display font-semibold text-muted-foreground py-5 cursor-pointer">
                            Will this affect my credit score?</summary>
                        <div class="text-gray-600 pb-5">No. Our eligibility assessment does not perform a credit check
                            and will not affect your credit score. We only review the documents you provide.</div>
                    </details>
                    <!-- FAQ 3 -->
                    <details class="bg-white rounded-xl border border-gray-200 px-6 overflow-hidden shadow">
                        <summary class="text-left font-display font-semibold text-muted-foreground py-5 cursor-pointer">
                            How long does the assessment take?</summary>
                        <div class="text-gray-600 pb-5">Most assessments are completed within 48 hours of submitting all
                            required documents. Complex cases may take slightly longer, but you'll always be kept
                            informed of your status.</div>
                    </details>
                    <!-- FAQ 4 -->
                    <details class="bg-white rounded-xl border border-gray-200 px-6 overflow-hidden shadow">
                        <summary class="text-left font-display font-semibold text-muted-foreground py-5 cursor-pointer">
                            Is my data secure?</summary>
                        <div class="text-gray-600 pb-5">Absolutely. We use bank-level 256-bit SSL encryption, store your
                            data on secure Canadian servers, and never share your information with third parties. Your
                            privacy is our priority.</div>
                    </details>
                    <!-- FAQ 5 -->
                    <details class="bg-white rounded-xl border border-gray-200 px-6 overflow-hidden shadow">
                        <summary class="text-left font-display font-semibold text-muted-foreground py-5 cursor-pointer">
                            What if I don't qualify?</summary>
                        <div class="text-gray-600 pb-5">If our assessment indicates you may not qualify for traditional
                            financing, we'll provide clear feedback on why and suggestions for what you might do to
                            improve your eligibility in the future.</div>
                    </details>
                    <!-- FAQ 6 -->
                    <details class="bg-white rounded-xl border border-gray-200 px-6 overflow-hidden shadow">
                        <summary class="text-left font-display font-semibold text-muted-foreground py-5 cursor-pointer">
                            Do I have to commit to anything?</summary>
                        <div class="text-gray-600 pb-5">No. The eligibility assessment is completely free with no
                            strings attached. You're under no obligation to proceed with a loan application after
                            receiving your results.</div>
                    </details>
                    <!-- FAQ 7 -->
                    <details class="bg-white rounded-xl border border-gray-200 px-6 overflow-hidden shadow">
                        <summary class="text-left font-display font-semibold text-muted-foreground py-5 cursor-pointer">
                            What documents do I need to upload?</summary>
                        <div class="text-gray-600 pb-5">Typically, we need recent bank statements (3-6 months), your
                            most recent tax returns, and financial statements if available. Our system will guide you
                            through exactly what's needed and identify any missing documents.</div>
                    </details>
                </div>
            </div>
        </div>
    ...
    <section class="py-20 lg:py-28 bg-white">
        <div class="container mx-auto">
            <div class="max-w-4xl mx-auto text-center">
                <h2 class="font-display text-3xl md:text-4xl lg:text-5xl font-bold text-primary mb-6">Stop Waiting.
                    Start Knowing.</h2>
                <p class="text-lg md:text-xl text-primary mb-10 max-w-2xl mx-auto">Find out if your business qualifies
                    for funding today. No credit check, no commitment, no waiting weeks for answers.</p>
                <div class="flex flex-col sm:flex-row gap-4 justify-center mb-10">
                    <a href="{{ auth()->check() ? route('dashboard') : route('login') }}"
                        class="group inline-flex items-center bg-primary gap-2 px-8 py-4 text-primary-foreground text-white rounded-lg font-semibold text-lg hover:shadow-xl transition-all duration-200 transform hover:-translate-y-1">
