                    ...
                    <form action="{{ route('admin.document-types.update', $documentType->id) }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea id="description" name="description" rows="4" 
                                ...
                                class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-teal-500 text-gray-900 transition-all resize-none">{{ old('description', $documentType->description) }}</textarea>
                            @error('description')
