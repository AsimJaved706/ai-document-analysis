            ...
            <div class="p-4 space-y-2">
                @forelse($documents as $doc)
                    <a href="{{ route('admin.chats.show', [$user->id, $doc->id]) }}"
                        class="block p-4 rounded-lg transition-colors {{ $selectedDocument?->id === $doc->id ? 'bg-teal-50 border-l-4 border-teal-500' : 'hover:bg-gray-50' }}">
                        ...
                        @if($doc->messages()->count() > 0)
                            <div class="flex items-center justify-between mt-2">
                                ...
                                <span class="text-xs bg-teal-100 text-teal-800 px-2 py-1 rounded">
                        ...
                        <div class="flex justify-between items-center">
                            <div>
                                ...
                                <p class="text-sm text-gray-600 mt-1">
                                    {{ ucwords(str_replace('_', ' ', $selectedDocument->doc_type)) }}
                                </p>
                            </div>
                    ...
                    <div class="bg-white border-t border-gray-200 p-6">
                        <form id="messageForm" class="flex space-x-2">
                            ...
                            <input type="text" id="messageInput" name="message" placeholder="Type your message..."
                                ...
                                required />
                            <button type="submit"
                                class="px-6 py-3 bg-gradient-to-r from-teal-600 to-emerald-600 text-white font-semibold rounded-lg hover:shadow-lg transition duration-300">
                                Send
                            </button>
                        </form>
                    </div>
            ...
            async function loadMessages() {
                try {
                    ...
                    data.messages.forEach(msg => {
                        ...
                        messageEl.innerHTML = `
                                <div class="relative">
                                    <div class="${isOwn ? 'bg-teal-600 text-white' : 'bg-gray-200 text-gray-900'} px-4 py-3 rounded-lg max-w-md">
